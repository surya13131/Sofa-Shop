...
const categories = [
  {
    name: 'Fabric',
    img: 'https://m.media-amazon.com/images/I/71eErF68xxL._UF894%2C1000_QL80_.jpg',
  },
  {
    name: 'Leather',
    img: 'http://shop.gkwretail.com/cdn/shop/products/DesignerSofaSet-AMIA3_2FabricLuxuryFurnitureSofaSet_NavyBlue.jpg?v=1645601836',
  },
  {
    name: 'Velvet',
    img: 'http://www.getmycouch.com/cdn/shop/files/WhatsAppImage2022-12-04at8.56.38PM.jpg?v=1687424099',
  },
  {
    name: 'Sectional',
    img: 'https://www.urbanwood.in//image/cache/catalog/fabric-sofas/abro-new/3-seater/navy-blue/look-400x281.jpg',
  },
  {
    name: 'Recliner',
    img: 'https://www.getmycouch.com/cdn/shop/products/liana-3-2-sofa-set-in-premium-blue-fabric-sofa-fn-gmc-005617-18936294015142_d2015288-7def-46e5-a621-9cc9f152b01c.jpg?v=1705569914',
  },
];
...
export default function Home() {
  ...
  const filteredSofas = sofas.filter((sofa) => {
    ...
    const matchesCategory =
      activeCategory === '' || sofa.name.toLowerCase().includes(activeCategory.toLowerCase());
    ...
    <>
      ...
      <main className="p-5 ms-lg-5 mt-3" >
        <section className="container text-center pt-5 mt-5 ms-lg-5 " >
          ...
          <div className="row row-cols-2 row-cols-sm-3 row-cols-md-5 g-4 justify-content-center  ms-lg-5 me-5" >
            {categories.map((cat, i) => (
              <div key={i} className="col d-flex justify-content-center">
                <div
                  ...
                  style={{ cursor: 'pointer', maxWidth: '180px', width: '100%' }}
                >
                  <img
                    src={cat.img}
        ...
        <section className="container py-5  ms-lg-5">
        ...
        <section className="bg-light py-5 px-3 mb-4  ms-lg-5">
          <div className="container text-center">
            <h2 className="mb-4 fw-bold">About Our Store</h2>
            <p className="lead mb-4">
              At <strong>GOODWILL LINING</strong>, we specialize in customized sofas, design chairs, cots, blinds,
              curtains, and mattresses tailored to your comfort and aesthetic.
            </p>
            <img src={BOTTOM_IMG} alt="Store" className="img-fluid rounded mb-4" style={{ maxHeight: '400px' }} />
            <h4 className="mt-4">Store Location</h4>
            <p>Goodwill Lining, Perambur, Chennai</p>
            <iframe
              title="Map"
